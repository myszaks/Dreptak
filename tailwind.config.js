    ...
    extend: {
      ...
      keyframes: {
        ...
        "pulse-glow": {
          ...
          "50%": { boxShadow: "0 0 20px #0ea5e9, 0 0 40px #0ea5e9" },
        },
        shimmer: {
      ...
      backgroundImage: {
        ...
        "fire-gradient": "linear-gradient(135deg, #f97316 0%, #ef4444 50%, #dc2626 100%)",
        "ocean-gradient": "linear-gradient(135deg, #0ea5e9 0%, #6366f1 100%)",
        "podium-gradient": "linear-gradient(180deg, #fbbf24 0%, #f59e0b 100%)",
      },
      screens: {
        xs: "390px",
      },
